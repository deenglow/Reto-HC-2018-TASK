...
class Usuario {
    ...
    public function updateUsuario(){
        $consulta = $this->conexion->prepare("UPDATE ".$this->table." SET nombre=:nombre,apellido1=:apellido1,apellido2=:apellido2,email=:email,telefono=:telefono,contrasena=:contrasena WHERE idUsuario=:id " );
